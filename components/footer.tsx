      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <a 
              href="mailto:hammoudi.yousuf@gmail.com" 
              className="text-xl font-medium hover:text-blue-400 transition-colors block mb-2"
            >
              hammoudi.yousuf@gmail.com
            </a>
            <a 
              href="tel:+251955339467" 
              className="text-xl font-medium hover:text-blue-400 transition-colors block"
            >
              +251955339467
            </a>
          </div>
